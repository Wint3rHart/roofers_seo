/**
 * FAQ content shown on the homepage FAQ accordion.
 * Also consumed server-side by src/app/page.js to build FAQPage JSON-LD
 * (kept out of home_page/faq.js since that's a "use client" component).
 */
