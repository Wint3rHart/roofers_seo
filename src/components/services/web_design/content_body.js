...
export const TOC_ITEMS = [
  { id: "the-problem", label: "What's Costing You Bookings Right Now" },
...
const data = SERVICE_DATA["web-design"];
...
export default function ContentBody() {
  ...
  return (
    <div>
      <Section id="the-problem" title="What's Quietly Costing You Bookings Right Now" reduce={reduce}>
