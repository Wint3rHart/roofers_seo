...
export const TOC_ITEMS = [
  { id: "the-problem", label: "What's Costing You Reviews Right Now" },
...
const data = SERVICE_DATA["reputation-management"];
...
export default function ContentBody() {
  ...
  return (
    <div>
      <Section id="the-problem" title="What's Quietly Costing You Reviews Right Now" reduce={reduce}>
